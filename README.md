...
A security-conscious reference design for using **Network UPS Tools (NUT)** with a small Linux controller such as a Raspberry Pi, assisting to gracefully shutdown multiple Linux Windows clients, optional libvirt/KVM virtual machines, email alerts, with a lightweight dashboard for ease of monitoring.
